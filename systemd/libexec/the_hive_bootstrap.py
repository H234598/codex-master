...
_FORMAT = "the-hive-home-broker-manifest-v1"
_FAILURE = "the-hive bootstrap verification failed"
...
def dispatch(mode: str, operations: BootstrapOperations) -> VerifiedPayload:
    try:
        ...
        required_path = {
            "broker": "bin/the-hive-home-broker",
            "agent": "python/the_hive/fleet_agent_launcher.py",
        }.get(mode)
