...
directories to be real directories, not symlinks, and legacy raw-log directories
are ignored when they are symlinks. Agentin metadata reads reject symlinked and
oversized files. MCP tool responses do not return raw output by default.
