...
from the_hive.hive.migration import migration_status, rollback_hive_state
from the_hive.hive.runtime import HiveRuntimeEvidence
from the_hive.hive.status import hive_doctor, hive_status, selection_status
from the_hive.runtime_status import runtime_status
from the_hive.selection.reset_anchor import AnchorRecord, ResetAnchorPlanner

if TYPE_CHECKING:
    from the_hive.hive.evidence_service import HiveTestEvidenceService
...
def run_hive_cli(
    ...
    *,
    ...
    if test_command is not None:
        from the_hive.hive.evidence_service import build_local_test_service, probe_test_index
